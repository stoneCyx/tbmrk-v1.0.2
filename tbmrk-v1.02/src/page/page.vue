                            ...
                            <li class="panel_comments clearfix" v-for="comment in getCommentList">
                                ...
                                <div class="panel_comments_content">
                                    <div class="panel_comments_head">
                                        <span>
                                            <router-link :to="{ name: 'userIndex', params: { uid:comment.userId._id }}" class="link">
                                ...
                                <div v-for="commentChildren in comment.children">
                                    <div style="margin-left:10px;margin-top:10px;" class="panel_comments_content">
                                        <div class="panel_comments_head">
                                            <span>
                                                <router-link :to="{ name: 'userIndex', params: { uid:commentChildren.userId._id }}" class="link">
                                                    <strong>{{commentChildren.userId.nickname}}</strong>
                                                </router-link>
                                                <span> 回复 </span>
                                                <router-link :to="{ name: 'userIndex', params: { uid:comment.userId._id }}" class="link">
                                                    <strong>{{commentChildren.userId.nickname}}</strong>
                                            ...
                                            <span class="panel_color_grey">{{commentChildren.created | minute}}</span>
                                            <span class="fr" v-if="myComment(commentChildren.userId._id)"><a href="javascript:void(0)" class="link" @click="delCommentModal(commentChildren._id)" title="删除"><i class="iconfont icon-delete"></i></a></span>
                                        </div>
                                        <div>{{commentChildren.content}}</div>
                                    </div>
                                </div>
                            </li>
                        </ul>
