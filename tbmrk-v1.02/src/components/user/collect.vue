    ...
    <div class="row">
        ...
        <div class="col-md-9 pad_l0">
                        ...
                        <div class="panel_body">
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-xs-6 pad_l0">
                                    <img class="panel_body_img" :src="arcitle.authId.header">
                                </div>
                            </div>
                        </div>
            ...
            <div class="panel_msg">
                ...
                <template v-if="getArticleUser.status == 2">没有更多日记啦</template>
            </div>
        </div>
    </div>
</template>
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ...mapActions({
                articleUserCollect: 'articleUserCollect',
        ...
        methods: {
            loadArticle(){
                ...
                this.$store.dispatch('articleUserCollect', data);
            },
            loadMore() {
