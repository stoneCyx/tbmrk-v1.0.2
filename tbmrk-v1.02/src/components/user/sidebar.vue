<template>
    <div>
        <div class="panel_s clearfix" v-if="user()">
            <router-link to="/article" class="btn btn-info col-xs-12">写日记</router-link>
        </div>
        <div class="panel_s">
            <div class="panel_homepage_num clearfix text-center">
                ...
                <div class="col-xs-4 panel_homepage_box">
                    <router-link :to="{ name: 'userCollect', params: { uid }}">
        ...
        <div class="panel_s">
            ...
            <div class="panel_s_body">
                <ul class="ul_text">
                    ...
                    <li v-if="getUser.info.birthday.month != 0 && getUser.info.birthday.day != 0">生日： {{getUser.info.birthday.month}}月{{getUser.info.birthday.day}}日</li>
