                        ...
                        <div class="row" v-if="getUser.own">
                            <div class="col-md-8">
                                ...
                                <div class="set_form clearfix">
                                    ...
                                    <div class="inp">
                                        <span>
                                            <select  name="birthdayMonth" :value="getUser.info.birthday.month" class="form-control set_select" @change="newUser">
                                        ...
                                        <span>
                                            <select name="birthdayDay" :value="getUser.info.birthday.day" class="form-control set_select" @change="newUser">
                                                <option value="0"></option>
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
    ...
    export default {
        ...
        mounted(){
            ...
            this.url = (process.env.NODE_ENV === 'production')
                ? 'http://api.tbmrk.com/v1/user/header'
                :'http://localhost:3000/v1/user/header';
        },
        methods: {
            newUser (e) {
